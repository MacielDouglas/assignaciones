...
export default function Loading() {
  return (
    <main className="mx-auto w-full max-w-4xl flex-1">
      <div className="from-primary/90 to-primary/80 px-4 pt-3 pb-5 sm:px-6">
      ...
      <div className="mx-auto w-full space-y-2.5 px-4 pt-4 sm:px-6">
...
function ChevronPlaceholder() {
  return <Skeleton className="size-5 shrink-0 rounded-sm" />;
}
