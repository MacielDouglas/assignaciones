import { getSectors, upsertSector } from "@/features/settings/lib/cleaning-data";
...
export async function GET(
  request: Request,
  ctx: RouteContext<"/api/organizations/[id]/settings/cleaning/sectors">,
) {
  try {
    ...
    const sectors = await getSectors(id);
...
export async function POST(
  ...
  try {
    ...
    const result = await upsertSector(id, parsed.data);
