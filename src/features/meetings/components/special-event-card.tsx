...
const EVENT_NOTE =
  "Programas como congressos e assembleias fortalecem nossa fé e nos aproximam ainda mais de Jeová e dos irmãos.";
 ...
 *
 * Visual dentro do design system: cartão neutro hairline, tile em ardósia
 * (section-neutral), sem gradientes nem sombras decorativas.
 */
export function SpecialEventCard({ event }: { event: MeetingSpecialEvent }) {
  ...
  return (
    <section
      ...
      className="bg-card anim-rise-in rounded-3xl border px-6 py-10 sm:px-10 sm:py-14"
    >
      <div className="mx-auto flex max-w-xl flex-col items-center text-center">
        <span
          className="flex size-16 items-center justify-center rounded-2xl text-white shadow-xs"
        ...
        <p className="text-muted-foreground mt-5 max-w-lg text-sm leading-relaxed">{EVENT_NOTE}</p>

        <dl className="mt-7 grid w-full grid-cols-1 gap-2 min-[420px]:grid-cols-2">
